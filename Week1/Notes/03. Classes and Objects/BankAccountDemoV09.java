 ...
 *
 * V09: When primitive data types are passed as arguments, the receiving method
 *      references a local copy of the value.
 *      That means that the original value in the calling method *CANNOT* be
 *      modified by the receiving method.
 *      When objects are passed as arguments, the receiving method
 *      references the address of the object's blob.
 *      That means that the original object in the calling method *CAN* be
 *      modified by the receiving method.
 *
 * @author David Habermehl
 * @version Last modified 13_Nov_2017
 **/
public class BankAccountDemoV09 {
    public static void main( String [] args ) {
        ...
        System.out.println( "Calling increaseBankAccountBalanceBy2X( account1 );" );
        increaseBankAccountBalanceBy2X( account1 );
        System.out.printf( "%s\n", account1 );
    ...
    /**
     * Method doubles the account balance of the BankAccount object passed as argument.
     *
     * @param  theAccountToModify  The BankAccount object to modify
     */
    static void increaseBankAccountBalanceBy2X( BankAccount theAccountToModify ) {
        double oldBalance = theAccountToModify.getAccountBalance(),
               newBalance = oldBalance * 2;
        theAccountToModify.setAccountBalance( newBalance );
    }
