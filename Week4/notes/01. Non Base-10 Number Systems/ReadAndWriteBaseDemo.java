 ...
 *  @version: Last Modified October 13, 2018
 */
...
class ReadAndWriteBaseDemo
{
    ...
    static int readBase (int base)
    {
        ...
        do                                      // Ignore white space and non-base chars
        {
            ch = keyboard.next().charAt(0);
        }
        while (  (ch < '0' ||  ch -'0' >= base ));
        int n = 0;    // ch is a legitimate digit char in the base
        do
    ...
    {   // rough equivalent to System.out.println (n), where n is an integer
