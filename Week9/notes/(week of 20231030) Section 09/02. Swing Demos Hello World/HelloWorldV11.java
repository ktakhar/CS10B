// HelloWorldV11: Layout code moved into a layoutComponents() method,
//                Plumbing code moved into a addListeners method.
//                Business logic moved into event handler methods.

//                Uses the "ActionListener class is an inner class" strategy.

import javax.swing.*;
import java.awt.*;
import java.awt.event.*;

public class HelloWorldV11 {

    private static final String TITLE="Hello World 11";
...
class MyWindow extends JFrame {
    ...
    private void addListeners() {
        ...
        buttonRed.addActionListener( new MyActionListener() );
        buttonYellow.addActionListener( new MyActionListener() );
    ...
    // This version of the program implements the ActionListener in an inner class.
    class MyActionListener implements ActionListener {
        ...
        public void actionPerformed(ActionEvent ae) {
            ...
            // System.out.printf( "In MyActionListener.actionPerformed, this.getClas() is \"%s\"\n", this.getClass() );
